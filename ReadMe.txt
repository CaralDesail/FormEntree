...
L'objectif de cette web application est double : Accelerer la partie "remplissage informatique" lors de l'admission des patients.
Remplir "automatiquement" le formulaire PMSI demandé par la structure à chaque entrée, et qui reprend parfois mot pour mot des éléments que l'on a déjà remplis avant ... Une documentation technique est disponible dans le répertoire "help".
